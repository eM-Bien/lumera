...
export const story = {
  ...
  right: [
    ...
    "W Lumera nie wierzymy w uniwersalne rozwiązania. Każda skóra, każda skóra głowy i każda historia są wyjątkowe. Dlatego stawiamy na konsultację, edukację i pielęgnację dopasowaną do Ciebie.",
